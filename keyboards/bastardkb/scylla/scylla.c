...
led_config_t g_led_config = { {
    ...
    // left
    { 102,  48 }, { 102,  32 }, { 102,  16 }, { 102,   0 }, // col 6 from top (col 1 PCB)
    {  81,  48 }, {  81,  32 }, {  81,  16 }, {  81,   0 }, // col 5 from top (col 2 PCB)
    {  61,  48 }, {  61,  32 }, {  61,  16 }, {  61,   0 }, // col 4 from top (col 3 PCB)
    {  41,  48 }, {  41,  32 }, {  41,  16 }, {  41,   0 }, // col 3 from top (col 4 PCB)
    {  20,  48 }, {  20,  32 }, {  20,  16 }, {  20,   0 }, // col 2 from top (col 5 PCB)
    {   0,  48 }, {   0,  32 }, {   0,  16 }, {   0,   0 }, // col 1 from top (col 6 PCB)
